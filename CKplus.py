...
class CKplus(data.Dataset):
    ...
    def __init__(self, split='Training', fold = 1, transform=None):
        ...
        self.data = h5py.File('./dataset/CK+_data.h5', 'r', driver='core')

        number = len(self.data['data_label']) #981
        sum_number = [0,135,312,387,594,678,927,981] # the sum of class number
        test_number = [12,18,9,21,9,24,7] # the number of each class
        # test_number = [14,20,11,23,11,26,8] # the number of each class
